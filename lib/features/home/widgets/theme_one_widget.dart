        ...
        return Stack(children: [
          ...
          Positioned(child: Column(
            children: [
                    ...
                    children: [
                      if(splashController.configModel!.systemFeature!.sendMoneyStatus!)
                       Expanded(
                        ...
                        image: Images.sendMoneyLogo, text: 'Save'.tr.replaceAll(' ', '\n'),
                      ...
                      Expanded(
                        child: OptionCardWidget(
                        image: Images.sendMoneyLogo, text: 'Send'.tr.replaceAll(' ', '\n'),
                        // color: Theme.of(context).secondaryHeaderColor,
                        onTap: ()=> Get.to(()=> const TransactionMoneyScreen(
                          fromEdit: false,
                          transactionType: TransactionType.sendMoney,
                      ...
                      Expanded(
                        child: OptionCardWidget(
                        image: Images.sendMoneyLogo, text: 'Loans'.tr.replaceAll(' ', '\n'),
                        // color: Theme.of(context).secondaryHeaderColor,
                        onTap: ()=> Get.to(()=> const TransactionMoneyScreen(
                          fromEdit: false,
                          transactionType: TransactionType.sendMoney,
                      ...
                      Expanded(
                        child: OptionCardWidget(
                        image: Images.sendMoneyLogo, text: 'Invest'.tr.replaceAll(' ', '\n'),
                        // color: Theme.of(context).secondaryHeaderColor,
                        onTap: ()=> Get.to(()=> const TransactionMoneyScreen(
                          fromEdit: false,
                          transactionType: TransactionType.sendMoney,
              ...
              Container(
                width: double.infinity, height: Get.height * 0.3,
