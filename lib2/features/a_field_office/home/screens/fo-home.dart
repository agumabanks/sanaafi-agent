...
import '../../LoanCalculator/screens/LoanCalculatorPage.dart';
import '../../clients/screens/addClient.dart';
import '../../../auth/controllers/auth_controller.dart';
import '../../../camera_verification/widgets/camera_screen.dart';
import '../../../home/widgets/bottomsheet_content_widget.dart';
import '../../../home/widgets/persistent_header_widget.dart';
...
Container(
  ...
  child: InkWell(
    onTap: () async {
      // 1) Call a controller method, e.g. fetch savings
      //    This might be something like:
        //  Get.find<SavingsController>().fetchSavingsList();
          await Get.find<SavingsController>().fetchAllSavings();


      // 2) Then navigate to a dedicated screen that shows the list:
      //    e.g. Get.toNamed(RouteHelper.getSavingsListRoute()); 
      //    or   
      Get.to(() => const SavingsListScreen());

      // Get.find<SavingsController>().fetchSavingsList();
      Get.to(() => const SavingsListScreen());

      Get.toNamed('/savings-list'); 
      // ^ Adjust to your route, e.g. RouteHelper.getSavingsListRoute()
    },
    child: const Column(
      mainAxisAlignment: MainAxisAlignment.center,
      crossAxisAlignment: CrossAxisAlignment.center,
