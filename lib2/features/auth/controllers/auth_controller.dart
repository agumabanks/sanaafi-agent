...
import '../../a_field_office/clients/domain/client.dart';
import '../../a_field_office/clients/domain/clientProfile.dart';
import '../../a_field_office/clients/domain/clientShortData.dart';
import '../../a_field_office/home/domain/AgentTodaysLoans.dart';
// import 'package:six_cash/features/a_field_office/loans/domain/userLoan.dart';
import '../../a_field_office/loans/loans/domain/userLoan.dart';
import '../../camera_verification/controllers/qr_code_scanner_controller.dart';
import '../../setting/domain/models/profile_model.dart';
...
import '../domain/models/user_short_data_model.dart';
import '../domain/reposotories/auth_repo.dart';
...
// pay loan
// https://app.sanaa.co/api/v1/loans/pay?client_id=59&amount=1973
...
Future<void> getUserByPhone(String phone) async {
  try {
    ...
    final url = Uri.parse('https://app.sanaa.co/api/v1/getUserByPhone');
